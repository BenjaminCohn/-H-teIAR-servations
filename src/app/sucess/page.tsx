...
// Empêche Next de tenter de pré-rendre la page au build
...
export default async function SuccessPage({
  ...
  // ✅ Stripe créé uniquement ici (pas au top-level)
    ...
    <main className="min-h-screen flex items-center justify-center p-8 text-white">
      <div className="max-w-xl w-full rounded-2xl border border-white/10 bg-white/5 p-8">
        <h1 className="text-2xl font-bold">
          {session ? (paid ? "Paiement confirmé ✅" : "Paiement en attente ⏳") : "Session introuvable ❌"}
        </h1>
